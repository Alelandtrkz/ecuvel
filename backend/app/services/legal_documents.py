...
FAMILIES: tuple[FamilyDefinition, ...] = (
    ...
    FamilyDefinition(
        ...
        documents=(
            _draft(
                "vendedores", "como-vender", "Cómo vender en ECUVEL",
                "Introducción al proceso para vendedores.", 10,
                template_name="docs/content/vendedores/como_vender.html",
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("elegibilidad-y-cuenta", "Elegibilidad y cuenta"),
                    ("incorporacion", "Incorporación en cinco pasos"),
                    ("revision-y-correcciones", "Revisión y correcciones"),
                    ("banca-y-contrato", "Banca y contrato"),
                    ("habilitacion", "Habilitación"),
                    ("tienda-y-miembros", "Tienda y miembros"),
                    ("actualizacion-y-ayuda", "Actualización y ayuda"),
                ),
            ),
            _draft(
                "vendedores", "politicas", "Políticas para vendedores",
                "Políticas operativas de la plataforma para tiendas.", 20,
                template_name="docs/content/vendedores/politicas.html",
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("rol-de-la-tienda", "Rol de la Tienda"),
                    ("publicaciones-y-precios", "Publicaciones y precios"),
                    ("stock-y-preparacion", "Stock y preparación"),
                    ("facturacion", "Facturación"),
                    ("garantias-y-reclamos", "Garantías y reclamos"),
                    ("fraude-y-colaboracion", "Fraude y colaboración"),
                    ("medidas-y-revision", "Medidas y revisión"),
                ),
            ),
            _draft(
                "vendedores", "productos-permitidos-y-prohibidos",
                "Productos permitidos y prohibidos",
                "Reglas del catálogo para vendedores.", 30,
                template_name=(
                ...
                sections=(
                    ...
                    ("clasificacion", "Clasificación"),
                    ("prohibidos", "Productos prohibidos"),
                    ("no-soportados", "Productos no soportados"),
                    ("regulados", "Productos regulados o condicionales"),
                    ("cosmeticos-y-arcsa", "Cosméticos y ARCSA"),
                    ("mercancia-general", "Mercancía general"),
                    ("documentacion-y-trazabilidad", "Documentación y trazabilidad"),
                    ("seguridad-y-retiros", "Seguridad y retiros"),
                ),
            ),
            _draft(
                "vendedores", "comisiones", "Comisiones",
                "Estructura y aplicación de comisiones.", 40,
                template_name="docs/content/vendedores/comisiones.html",
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("precio-minimo", "Precio mínimo"),
                    ("tarifa-fija", "Tarifa fija"),
                    ("comision-porcentual", "Comisión porcentual"),
                    ("snapshot", "Snapshot de comisión"),
                    ("neto-seller", "Neto Seller"),
                    ("cambios-y-anexos", "Cambios y anexos"),
                ),
            ),
            _draft(
                "vendedores", "pagos-y-liquidaciones", "Pagos y liquidaciones",
                "Proceso de liquidación a vendedores.", 50,
                template_name="docs/content/vendedores/pagos_y_liquidaciones.html",
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("pmt-y-pay", "PMT- y PAY-"),
                    ("elegibilidad", "Elegibilidad"),
                    ("liberacion-y-conciliacion", "Liberación y conciliación"),
                    ("cuenta-bancaria", "Cuenta bancaria"),
                    ("ciclos", "Ciclos"),
                    ("calculo-y-evidencia", "Cálculo y evidencia"),
                    ("estados-e-incidencias", "Estados e incidencias"),
                    ("acreditacion-bancaria", "Acreditación bancaria"),
                ),
            ),
            _draft(
                "vendedores", "logistica", "Logística",
                "Preparación y entrega de productos a ECUVEL.", 60,
                template_name="docs/content/vendedores/logistica.html",
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("stock-y-reserva", "Stock y reserva"),
                    ("confirmacion-prevista", "Confirmación prevista"),
                    ("preparacion-e-identificacion", "Preparación e identificación"),
                    ("recepcion-y-custodia", "Recepción y custodia"),
                    ("retiro-y-trazabilidad", "Retiro y trazabilidad"),
                    ("no-retiro", "Falta de retiro"),
                    ("incidencias-y-devoluciones", "Incidencias y devoluciones"),
                ),
            ),
            _draft(
                "vendedores", "contrato", "Contrato de vendedor",
                "Acceso y relación con el contrato comercial separado de Partners.", 70,
                template_name="docs/content/vendedores/contrato.html",
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("finalidad", "Finalidad"),
                    ("disponibilidad", "Disponibilidad"),
                    ("aceptacion-en-partners", "Aceptación en Partners"),
                    ("version-y-anexos", "Versión y anexos"),
                    ("evidencia", "Evidencia"),
                    ("acceso-e-historial", "Acceso e historial"),
                    ("cambios-futuros", "Cambios futuros"),
                ),
            ),
            _draft(
                "vendedores", "proteccion-de-datos-seller",
                "Protección de datos Seller",
                "Tratamientos asociados al onboarding y operación de tiendas.", 80,
                template_name=(
                    "docs/content/vendedores/proteccion_de_datos_seller.html"
                ),
                sections=(
                    ("estado-y-alcance", "Estado y alcance"),
                    ("datos-de-incorporacion", "Datos de incorporación"),
                    ("banca-y-contrato", "Banca y contrato"),
                    ("tienda-productos-y-operaciones", "Tienda, productos y operaciones"),
                    ("finalidades-y-bases", "Finalidades y bases"),
                    ("destinatarios-y-proveedores", "Destinatarios y proveedores"),
                    ("transferencias", "Transferencias"),
                    ("conservacion", "Conservación"),
                    ("seguridad-e-incidentes", "Seguridad e incidentes"),
                    ("derechos-y-contacto", "Derechos y contacto"),
                ),
            ),
        ),
    ),
